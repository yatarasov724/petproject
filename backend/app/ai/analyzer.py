...
- Только если компания ПРЯМО упомянута в новости
- Нефтяные котировки / ОПЕК / мировой нефтяной рынок (без конкретной компании) → LKOH, ROSN
- Цена газа / газовый рынок (без конкретной компании) → GAZP, NVTK
- Золото / цена золота (без компании) → PLZL
